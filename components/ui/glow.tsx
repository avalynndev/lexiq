  ...
  return (
    <div
      className={cn(
        ...
        {
          "bg-linear-to-t from-purple-500/20 via-transparent to-transparent": variant === "top",
          "bg-linear-to-b from-purple-500/20 via-transparent to-transparent": variant === "bottom",
